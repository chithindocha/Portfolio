...
const Footer = () => {
    ...
    return (
        <nav className='flex justify-between items-center py-20 flex-col gap-5  '>
            <h1 className='text-white text-xl bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 bg-[length:100%_4px] bg-no-repeat bg-bottom'>Made by Chit</h1>
